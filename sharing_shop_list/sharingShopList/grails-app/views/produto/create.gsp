...
<html>
	<head>
		...
		<title><g:message code="produto.create.label" args="[entityName]" /></title>
	</head>
	<body>
		...
		<div id="create-produto" class="content scaffold-create" role="main">
			<h1><g:message code="produto.create.label" args="[entityName]" /></h1>
			...
			<g:form url="[resource:produtoInstance, action:'save']" >
				...
				<fieldset class="buttons">
					<g:submitButton name="create" class="save" value="${message(code: 'produto.button.create.label', default: 'Create')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
