...
<html>
	<head>
		...
		<title><g:message code="produto.edit.label" args="[entityName]" /></title>
	</head>
	<body>
		...
		<div id="edit-produto" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:produtoInstance, action:'update']" method="PUT" >
				...
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="update" value="${message(code: 'produto.update.label', default: 'Update')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
