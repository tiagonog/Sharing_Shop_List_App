	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.listas}">
				<li class="fieldcontain">
					<span id="listas-label" class="property-label"><g:message code="usuario.listas.label" default="Listas" /></span>

						<g:each in="${usuarioInstance.listas}" var="l">
						<span class="property-value" aria-labelledby="listas-label"><g:link controller="lista" action="show" id="${l.id}">${l?.encodeAsHTML()}</g:link></span>
						</g:each>
